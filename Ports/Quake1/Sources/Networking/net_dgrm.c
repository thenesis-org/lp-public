...
PollProcedure testPollProcedure = { NULL, 0.0f, Test_Poll };
...
static void Test_Poll()
{
	...
	if (testPollCount)
	{
		SchedulePollProcedure(&testPollProcedure, 0.1f);
	}
	else
	{
...
PollProcedure test2PollProcedure = { NULL, 0.0f, Test2_Poll };
...
Reschedule:
	SchedulePollProcedure(&test2PollProcedure, 0.05f);
	return;
