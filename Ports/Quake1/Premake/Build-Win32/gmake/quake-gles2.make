...
ifeq ($(config),release)
  OBJDIR     = ../../../../Output/Targets/Windows-x86-32/Release/obj/quake-gles2
  TARGETDIR  = ../../../../Output/Targets/Windows-x86-32/Release/bin
  TARGET     = $(TARGETDIR)/quake-gles2.exe
  DEFINES   += -DEGLW_GLES2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../../Output/Targets/Windows-x86-32/Debug/obj/quake-gles2
