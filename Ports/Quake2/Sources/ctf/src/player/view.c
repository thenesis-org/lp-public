...
void P_WorldEffects(void)
{
	...
	if ((old_waterlevel == 3) && (waterlevel != 3))
	{
		...
		if (current_player->air_finished < level.time + 11)
		{
			/* just break surface */
			gi.sound(current_player, CHAN_VOICE,
...
void ClientEndServerFrame(edict_t *ent)
{
	...
	xyspeed = sqrtf(ent->velocity[0] * ent->velocity[0] + ent->velocity[1] *
			ent->velocity[1]);
