...
void sphere_explode(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker /* unused */, int damage /* unused */, vec3_t point /* unused */)
{
	if (!self)
	{
		return;
...
void sphere_if_idle_die(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker /* unused */, int damage /* unused */, vec3_t point /* unused */)
{
	if (!self)
	{
		return;
...
void sphere_chase(edict_t *self, int stupidChase)
{
	...
	if (VectorCompare(self->monsterinfo.saved_goal, vec3_origin))
	{
...
void hunter_think(edict_t *self)
{
	...
	if (self->enemy)      /* fired by doppleganger */
	{
		VectorSubtract(self->enemy->s.origin, self->s.origin, dir);
