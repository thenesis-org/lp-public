 ...
 * 232 - blood
 */
void use_target_steam(edict_t *self, edict_t *other, edict_t *activator /* unused */)
{
	static int nextid;
	vec3_t point;
	...
	VectorMA(self->s.origin, self->plat2flags * 0.5f, self->movedir, point);
...
void target_anger_use(edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	edict_t *target;
	edict_t *t;
...
void target_killplayers_use(edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	int i;
	edict_t *ent, *player;
