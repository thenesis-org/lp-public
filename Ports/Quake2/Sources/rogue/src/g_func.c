...
void Move_Begin(edict_t *ent)
{
	...
	frames = floorf((ent->moveinfo.remaining_distance /
...
void plat_blocked(edict_t *self, edict_t *other)
{
	...
	if (!(other->svflags & SVF_MONSTER) && (!other->client))
	{
		...
		if (other)
		{
			...
			VectorMA(other->absmin, 0.5f, other->size, other->s.origin);
...
void Use_Plat(edict_t *ent, edict_t *other, edict_t *activator /* unused */)
{
	if (!ent || !other)
	{
		return;
...
void Touch_Plat_Center(edict_t *ent, edict_t *other, cplane_t *plane /* unsed */, csurface_t *surf /* unused */)
{
	if (!ent || !other)
	{
		return;
...
void plat2_hit_bottom(edict_t *ent)
{
	...
	if ((ent->spawnflags & PLAT2_TOP) && !(ent->spawnflags & PLAT2_TOGGLE))
	{
		ent->plat2flags = 0;
		ent->think = plat2_go_up;
		ent->nextthink = level.time + 2.0f;
...
void Touch_Plat_Center2(edict_t *ent, edict_t *other, cplane_t *plane /* unused */, csurface_t *surf /* unused */)
{
	if (!ent || !other)
	{
		return;
...
void Use_Plat2(edict_t *ent, edict_t *other /* unused */, edict_t *activator)
{
	edict_t *trigger;
	int i;
...
void plat2_activate(edict_t *ent, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	edict_t *trigger;
...
void rotating_touch(edict_t *self, edict_t *other, cplane_t *plane /* unused */, csurface_t *surf /* unused */)
{
	if (!self || !other)
	{
		return;
...
void button_use(edict_t *self, edict_t *other /* unused */, edict_t *activator)
{
	if (!self || !activator)
	{
		return;
...
void button_touch(edict_t *self, edict_t *other, cplane_t *plane /* unused */, csurface_t *surf /* unused */)
{
	if (!self || !other)
	{
		return;
...
void button_killed(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker, int damage /* unused */, vec3_t point /* unused */)
{
	if (!self || !attacker)
	{
		return;
...
void door_use(edict_t *self, edict_t *other /* unused */, edict_t *activator)
{
	edict_t *ent;
	vec3_t center;
...
void Touch_DoorTrigger(edict_t *self, edict_t *other, cplane_t *plane /* unused */, csurface_t *surf /* unused */)
{
	if (!self || !other)
	{
		return;
...
void door_killed(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker, int damage /* unused */, vec3_t point /* unused */)
{
	edict_t *ent;
...
void Door_Activate(edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	if (!self)
	{
		return;
...
void train_use(edict_t *self, edict_t *other /* unused */, edict_t *activator)
{
	if (!self || !other)
	{
		return;
 ...
 */
void trigger_elevator_use(edict_t *self, edict_t *other, edict_t *activator /* unused */)
{
	edict_t *target;
...
void func_timer_use(edict_t *self, edict_t *other /* unused */, edict_t *activator)
{
	if (!self)
	{
		return;
...
void SP_func_timer(edict_t *self)
{
	...
	{
		self->nextthink = level.time + 1.0f + st.pausetime + self->delay +
 ...
 * speed	default 100
 */
void func_conveyor_use(edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	if (!self)
	{
		return;
 ...
 */
void door_secret_use(edict_t *self, edict_t *other /* unused */, edict_t *activator /*unused */)
{
	if (!self)
	{
		return;
...
void door_secret_die(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker, int damage /* unused */, vec3_t point /* unused */)
{
	if (!self)
	{
		return;
 ...
 */
void use_killbox(edict_t *self, edict_t *other /* unused */, edict_t *activator /* unused */)
{
	if (!self)
	{
		return;
