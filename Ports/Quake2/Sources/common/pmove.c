...
#define STOP_EPSILON 0.1f /* Slide off of the impacting object returns the blocked flags (1 = floorf, 2 = step / wall) */
...
void PM_ClampAngles(void)
{
	...
	else
	{
		...
		if ((pm->viewangles[PITCH] < 271) && (pm->viewangles[PITCH] >= 180))
		{
