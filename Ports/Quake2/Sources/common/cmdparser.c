...
void Cmd_ExecuteString(char *text)
{
	...
	if (Cmd_Argc() > 1 && Q_strcasecmp(cmd_argv[0], "exec") == 0 && Q_strcasecmp(cmd_argv[1], "platform.cfg") == 0)
	{
		/* exec platform.cfg is done directly after exec default.cfg, see Qcommon_Init() */
