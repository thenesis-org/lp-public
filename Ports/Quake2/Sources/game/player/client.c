...
void player_pain(edict_t *self /* unused */, edict_t *other /* unused */, float kick /* unused */, int damage /* unused */)
{
...
void LookAtKiller(edict_t *self, edict_t *inflictor, edict_t *attacker)
{
	...
	if (inflictor && (inflictor != world) && (inflictor != self))
	{
	...
	if (dir[0])
	{
		self->client->killer_yaw = 180 / Q_PI * atan2f(dir[1], dir[0]);
	}
	else
	{
...
void body_die(edict_t *self, edict_t *inflictor /* unused */, edict_t *attacker /* unused */, int damage, vec3_t point /* unused */)
{
	int n;
