...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Windows-x86-32/Release/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/Windows-x86-32/Release/bin/rogue
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Windows-x86-32/Debug/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/Windows-x86-32/Debug/bin/rogue
  TARGET     = $(TARGETDIR)/game.dll
  DEFINES   += -DARCH=\"x86\" -DOSTYPE=\"Windows\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I../../../../../Engine/External/Win32/include -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/rogue/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
