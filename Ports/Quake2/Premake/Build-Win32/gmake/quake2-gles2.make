...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Windows-x86-32/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/Windows-x86-32/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2.exe
  DEFINES   += -DARCH=\"x86\" -DOSTYPE=\"Windows\" -DNOUNCRYPT -DZIP -DEGLW_GLES2
  ...
  LIBS      += $(LDDEPS) -lgdi32 -lmingw32 -lws2_32 -lwinmm -lGLESv2.lib -lEGL.lib -lSDL2main -lSDL2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Windows-x86-32/Debug/obj/quake2-gles2
