...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Generic/Release/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/Generic/Release/bin/xatrix
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Generic/Debug/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/Generic/Debug/bin/xatrix
  TARGET     = $(TARGETDIR)/game.dll
  DEFINES   += -DARCH=\"x86\" -DOSTYPE=\"Windows\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I../../../../../Engine/External/Win32/include -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/xatrix/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
