...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Release/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/RaspberryPi/Release/bin/rogue
  TARGET     = $(TARGETDIR)/game.so
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I/opt/vc/include -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/rogue/src
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Debug/obj/quake2-rogue
  TARGETDIR  = ../../../Output/Targets/RaspberryPi/Debug/bin/rogue
  TARGET     = $(TARGETDIR)/game.so
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I/opt/vc/include -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/rogue/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
