...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Release/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/RaspberryPi/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1
  INCLUDES  += -I/opt/vc/include -I../../../../../Engine/External/include -I../../../Sources -I../../../../../Engine/Sources/Compatibility -I../../../../../Engine/Sources/Compatibility/OpenGLES/Includes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -ffast-math -Wall -Wextra -O2 -std=gnu99 -Wno-unused-function -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-switch -Wno-missing-field-initializers -fPIC -fvisibility=hidden
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/RaspberryPi/Release/lib -L/opt/vc/lib -L. -s
  LDDEPS    += ../../../Output/Targets/RaspberryPi/Release/lib/libZLib.a
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv1_CM -lEGL -lbcm_host -lSDL2main -lSDL2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Debug/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/RaspberryPi/Debug/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1
  INCLUDES  += -I/opt/vc/include -I../../../../../Engine/External/include -I../../../Sources -I../../../../../Engine/Sources/Compatibility -I../../../../../Engine/Sources/Compatibility/OpenGLES/Includes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -ffast-math -Wall -Wextra -g -std=gnu99 -Wno-unused-function -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-switch -Wno-missing-field-initializers -fPIC -fvisibility=hidden
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/RaspberryPi/Debug/lib -L/opt/vc/lib -L.
  LDDEPS    += ../../../Output/Targets/RaspberryPi/Debug/lib/libZLib.a
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv1_CM -lEGL -lbcm_host -lSDL2main -lSDL2
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
