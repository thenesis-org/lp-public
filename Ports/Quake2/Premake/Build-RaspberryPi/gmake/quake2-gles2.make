...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/RaspberryPi/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES2
  ...
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv2 -lEGL -lbcm_host -lSDL2main -lSDL2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/RaspberryPi/Debug/obj/quake2-gles2
