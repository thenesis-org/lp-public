...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/Generic/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/Generic/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2
  DEFINES   += -D__RASPBERRY_PI__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -DGLES2 -D_GNU_SOURCE=1 -DEGLW_GLES1
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Generic/Release/lib -L/opt/vc/lib -L. -s
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/Generic/Debug/obj/quake2-gles2
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Generic/Debug/lib -L/opt/vc/lib -L.
...
$(OBJDIR)/hunk.o: ../../../Sources/backends/unix/hunk.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/main.o: ../../../Sources/backends/unix/main.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/network.o: ../../../Sources/backends/unix/network.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/system.o: ../../../Sources/backends/unix/system.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
