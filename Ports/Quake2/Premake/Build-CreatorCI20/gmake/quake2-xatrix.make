...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Release/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/CreatorCI20/Release/bin/xatrix
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Debug/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/CreatorCI20/Debug/bin/xatrix
  TARGET     = $(TARGETDIR)/game.so
  DEFINES   += -D__CREATOR_CI20__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/xatrix/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
