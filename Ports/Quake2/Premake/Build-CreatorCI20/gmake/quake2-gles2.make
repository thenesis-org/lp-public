...
ifeq ($(config),release)
  ...
  DEFINES   += -D__CREATOR_CI20__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -DGLES2 -D_GNU_SOURCE=1 -DEGLW_GLES1
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Generic/Release/lib -L/usr/lib/mipsel-linux-gnu/sgx -L. -s
...
ifeq ($(config),debug)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/Generic/Debug/lib -L/usr/lib/mipsel-linux-gnu/sgx -L.
