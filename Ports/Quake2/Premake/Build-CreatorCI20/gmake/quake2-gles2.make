...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/CreatorCI20/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2
  DEFINES   += -D__CREATOR_CI20__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Debug/obj/quake2-gles2
