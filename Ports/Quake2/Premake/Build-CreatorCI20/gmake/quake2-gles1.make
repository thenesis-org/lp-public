...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Release/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/CreatorCI20/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -D__CREATOR_CI20__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/CreatorCI20/Release/lib -L/usr/lib/mipsel-linux-gnu/sgx -L. -s
  LDDEPS    += ../../../Output/Targets/CreatorCI20/Release/lib/libZLib.a
  LIBS      += $(LDDEPS) -lm -ldl -lGLES_CM -lSDL2main -lSDL2 -lX11
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/CreatorCI20/Debug/obj/quake2-gles1
  TARGETDIR  = ../../../Output/Targets/CreatorCI20/Debug/bin
  TARGET     = $(TARGETDIR)/quake2-gles1
  DEFINES   += -D__CREATOR_CI20__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES1
  INCLUDES  += -I../../../../../Engine/External/include -I../../../Sources -I../../../../../Engine/Sources/Compatibility -I../../../../../Engine/Sources/Compatibility/OpenGLES/Includes
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/CreatorCI20/Debug/lib -L/usr/lib/mipsel-linux-gnu/sgx -L.
  LDDEPS    += ../../../Output/Targets/CreatorCI20/Debug/lib/libZLib.a
  LIBS      += $(LDDEPS) -lm -ldl -lGLES_CM -lSDL2main -lSDL2 -lX11
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
