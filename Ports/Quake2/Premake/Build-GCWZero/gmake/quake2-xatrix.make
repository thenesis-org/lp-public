...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/GCWZero/Release/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/GCWZero/Release/bin/xatrix
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/GCWZero/Debug/obj/quake2-xatrix
  TARGETDIR  = ../../../Output/Targets/GCWZero/Debug/bin/xatrix
  TARGET     = $(TARGETDIR)/game.so
  DEFINES   += -D__GCW_ZERO__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP
  INCLUDES  += -I../../../../../Engine/External/include -I../../../Sources -I../../../Sources/xatrix/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
