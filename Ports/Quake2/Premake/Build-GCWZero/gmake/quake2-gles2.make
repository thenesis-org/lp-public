...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/GCWZero/Release/obj/quake2-gles2
  TARGETDIR  = ../../../Output/Targets/GCWZero/Release/bin
  TARGET     = $(TARGETDIR)/quake2-gles2
  DEFINES   += -D__GCW_ZERO__ -DARCH=\"i386\" -DOSTYPE=\"Linux\" -DNOUNCRYPT -DZIP -D_GNU_SOURCE=1 -DEGLW_GLES2
  ...
  LIBS      += $(LDDEPS) -lm -ldl -lGLESv2 -lEGL -lSDL2main -lSDL2
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/GCWZero/Debug/obj/quake2-gles2
