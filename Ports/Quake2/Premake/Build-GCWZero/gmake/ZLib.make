...
ifeq ($(config),release)
  OBJDIR     = ../../../Output/Targets/GCWZero/Release/obj/ZLib
  TARGETDIR  = ../../../Output/Targets/GCWZero/Release/lib
  TARGET     = $(TARGETDIR)/libZLib.a
  DEFINES   += -D__GCW_ZERO__
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/GCWZero/Release/lib -s
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),debug)
  OBJDIR     = ../../../Output/Targets/GCWZero/Debug/obj/ZLib
  TARGETDIR  = ../../../Output/Targets/GCWZero/Debug/lib
  TARGET     = $(TARGETDIR)/libZLib.a
  DEFINES   += -D__GCW_ZERO__
  INCLUDES  += -I../../../../../Engine/External/include -I../../../../../Engine/External/Sources/zlib
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L../../../Output/Targets/GCWZero/Debug/lib
  LDDEPS    +=
  LIBS      += $(LDDEPS)
  LINKCMD    = $(AR) -rcs $(TARGET) $(OBJECTS)
  define PREBUILDCMDS
